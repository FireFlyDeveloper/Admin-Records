    ...
    >
      ...
      <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mb-6">
        <StatCard
          ...
          onClick={() => navigate('/inventory?type=quantifiable&expiration=expired')}
        />
        <StatCard
          ...
          isLoading={statsLoading}
          onClick={() => navigate('/inventory?type=quantifiable&expiration=expiring_soon')}
        />
        <StatCard
          ...
          isLoading={statsLoading}
          onClick={() => navigate('/inventory?type=quantifiable&expiration=expiring_month')}
        />
        <StatCard
          label="Safe / Valid"
          ...
          isLoading={statsLoading}
          onClick={() => navigate('/inventory?type=quantifiable&expiration=safe')}
        />
      </div>
